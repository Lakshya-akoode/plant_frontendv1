...
import { exportCityListToCSV, exportCityListToExcel } from "../../../utils/exportUtils";
                          ...
                          {exportDropdownOpen && (
                            <>
                              ...
                              <div className="location-export-dropdown">
                                ...
                                <button
                                  onClick={() => {
                                    exportCityListToExcel(cityList);
                                    setExportDropdownOpen(false);
                                  }}
                                  className="location-export-item"
                                >
                  ...
                  <div className="my_dashboard_review mb40" style={{ marginTop: '10px' }}>
                    <div className="property_table">
                      <div className="table-responsive mt0" style={{
                        ...
                        `}</style>
                        <TableData onDataUpdate={setCityList} />
                      </div>
