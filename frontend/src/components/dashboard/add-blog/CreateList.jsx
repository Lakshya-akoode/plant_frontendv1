    ...
    <div className="col-lg-12">
      ...
      <div className="col-lg-12">
          <div className="my_profile_setting_textarea form-group">
            <label htmlFor="blogDescription">Description test</label>
            ...
            {/* <Editor value={description} onChange={handleDescriptionChange}/> */}
             <ReactQuill
                        ...
                        />
            {/* <textarea id="blogDescription" className="form-control" rows="7"  value={description} onChange={handleDescriptionChange}  placeholder="Enter blog description"></textarea> */}
            {error && <p className="text-red-500 text-sm mt-1">{error}</p>}
          </div>
