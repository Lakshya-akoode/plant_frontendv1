...
export async function getLandingEnquiryTableData(filter?: { limit?: number; page?: number }) {
  // Fake delay
...
export const updateLandingEnquiryAPI = async (id: string, landingenquiry: Record<string, unknown>) => { 
  // const token = localStorage.getItem("token"); // 🔹 Retrieve token
